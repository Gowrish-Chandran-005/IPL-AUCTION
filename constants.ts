...
export const INITIAL_PURSE = 10000; // 100 Crores in Lakhs (1 Cr = 100 L)

export const TEAMS: Team[] = [
  { id: 'csk', name: 'Chennai Super Kings', shortName: 'CSK', color: 'from-yellow-400 to-yellow-600', logo: '🦁', purse: INITIAL_PURSE },
  { id: 'mi', name: 'Mumbai Indians', shortName: 'MI', color: 'from-blue-500 to-blue-700', logo: '🌪️', purse: INITIAL_PURSE },
  { id: 'rcb', name: 'Royal Challengers Bengaluru', shortName: 'RCB', color: 'from-red-500 to-red-700', logo: '🦁', purse: INITIAL_PURSE },
  { id: 'kkr', name: 'Kolkata Knight Riders', shortName: 'KKR', color: 'from-purple-600 to-purple-800', logo: '🛡️', purse: INITIAL_PURSE },
  { id: 'lsg', name: 'Lucknow Super Giants', shortName: 'LSG', color: 'from-cyan-400 to-cyan-600', logo: '🦅', purse: INITIAL_PURSE },
  { id: 'gt', name: 'Gujarat Titans', shortName: 'GT', color: 'from-indigo-600 to-indigo-800', logo: '⚡', purse: INITIAL_PURSE },
  { id: 'srh', name: 'Sunrisers Hyderabad', shortName: 'SRH', color: 'from-orange-500 to-orange-700', logo: '☀️', purse: INITIAL_PURSE },
  { id: 'pbks', name: 'Punjab Kings', shortName: 'PBKS', color: 'from-red-400 to-red-600', logo: '👑', purse: INITIAL_PURSE },
  { id: 'rr', name: 'Rajasthan Royals', shortName: 'RR', color: 'from-pink-500 to-pink-700', logo: '👑', purse: INITIAL_PURSE },
  { id: 'dc', name: 'Delhi Capitals', shortName: 'DC', color: 'from-blue-400 to-blue-600', logo: '🐯', purse: INITIAL_PURSE },
];

export const PLAYERS: Player[] = [
  // MARQUEE PLAYERS - High Profile Cricket Stars (with actual roles)
